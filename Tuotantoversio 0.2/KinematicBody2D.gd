...
func _on_Area2D_body_entered(body): # Kun hahmo osuu alueeseen
	get_tree().change_scene("res://World.tscn") # Vaihtuu kenttä skene


func _on_Area2D2_body_entered(body): # Kun hahmo osuu alueeseen
	get_tree().change_scene("res://Voitto.tscn") # Vaihtuu voitto skene
